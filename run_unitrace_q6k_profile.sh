...
LLAMA_KERNELS="dequantize_mul_mat_vec_q4_K_sycl,dequantize_mul_mat_vec_q6_K_sycl,ggml_sycl_fused_q4k_swiglu_esimd,launch_kernel,rms_norm_mul_f32_sycl,gemm_kernel,lauch_kernel,launch_fattn,flash_attn_ext_vec_esimd"
